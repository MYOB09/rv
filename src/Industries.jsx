        ...
        >
          <CarouselContent>
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Fashion Retail</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Grocery Retail</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Beauty & Personal Care</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Electronics Retail</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Home & Furniture</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Pet Supplies Retail</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Bookstores</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Toy Stores</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Home Improvement & DIY</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2 rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Wine & Spirits Retail</span>
              <br />
              <br />
              <p>
            ...
            <CarouselItem className="text-center basis-1/2 p-4 m-4 border-2  rounded-xl bg-gray-100">
              <span className="text-xl font-bold">Online Marketplaces</span>
              <br />
              <br />
              <p>
